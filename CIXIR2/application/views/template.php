  ...
  <section id="container">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <div class="fa fa-bars tooltips" data-placement="right" data-original-title="Toggle Navigation"></div>
            ...
            <!--logo start-->
            <a href="<?= base_url()?>index.html" class="logo"><b>AMI'S PROFIL</b></a>
            <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="<?= base_url()?>v_profil.php"><img src="<?=base_url()?>assets/img/15.jpg" class="img-circle" width="60"></a></p>
              	  <h5 class="centered">Wahyu Utami</h5>
              	  	
                    <li class="active">
                    <a href="<?=base_url('index.php/user')?>">
                        <p class="material-icons" ><img src="<?=base_url()?>assets/img/home.png"  style="width: 30px;"><div style="margin-right: 85px; margin-top: -33px; font-size: 15px; float: right;">Home</div></p>
                  ...
                  <li class="active">
                      ...
                      <p class="material-icons" ><img src="<?=base_url()?>assets/img/user.png" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right;">Profil</div></p>
                      </a>
                  </li>

                  <li class="active">
                      <a href="<?=base_url('index.php/galeri')?>">
                      <p class="material-icons" ><img src="<?=base_url()?>assets/img/image.png" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right;">Galeri</div></p>
                      </a>
                  </li>

                  <li class="active">
                      <a href="<?=base_url('index.php/event')?>">
                      <p class="material-icons" ><img src="<?=base_url()?>assets/img/calendar.png" style="width: 30px;"><div style="margin-right: 90px; margin-top: -33px; font-size: 15px; float: right;">Event</div></p>
                      </a>
                  </li>
	...
	<script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            image: '<?= base_url()?>assets/img/15.jpg',
